...
function displayNavItem(text,link) {
	return '<tr class="navmenutr"><td class="navmenutd" title="'+text+'" style="border-width: 0 0 1px 1px ! important;" onMouseOver="this.className=\'navmenutd2\';status=\''+text+'\'" onMouseOut="this.className=\'navmenutd\';status=\'\'" onClick="location=\''+ link + '\'" id="navmenutd_top"><a href="'+ link + '">' + text + '</a></td></tr>';
}
...
function displayNavMenu() { 
	...
	navItemArray[3] = new navItem("Data", "http://dvn.iq.harvard.edu/dvn/dv/king"); 
...
function displaySearchGoogle() {
	...
	//<!-- Search Google -->
	searchGoogleHTML = '<div align="center" style="text-align:left"><form method="get" action="http://www.google.com/u/gking" name="googlesearch" onSubmit="if (document.forms.googlesearch.q.value == \'\' || document.forms.googlesearch.q.value == \'Enter search text\'){document.forms.googlesearch.q.focus();return false;}if (document.forms.googlesearch.sitesearch[2].checked){document.location.href=\'http://scholar.google.com/scholar?q=\'+document.forms.googlesearch.q.value;return false};">'
        if (bName.indexOf("Opera") != -1) {
            searchGoogleHTML += '<input type="text" name="q" size="31" maxlength="255" value="' + q + '" style="width:150px;  height:25px; padding:0px;" id="txtinputgoogle" title="Google Search" onFocus="return clearInputField(this)">'
            + '<input type="hidden" name="domains" value="gking.harvard.edu">'
            + '<br /><input type="radio" name="sitesearch" id="sitesearch1" value="gking.harvard.edu" checked="true"> <label for="sitesearch1">This Site</label>' 
            ...
            searchGoogleHTML += '<table cellspacing="0" border="0"><tr><td>'
            + '<input type="text" name="q" size="31" maxlength="255" value="' + q + '" class="txtinput" id="txtinputgoogle" title="Google Search" onFocus="return clearInputField(this)">'
            + '<input type="hidden" name="domains" value="gking.harvard.edu">'
