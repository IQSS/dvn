 ...
 */
public class RDATAMetadata extends SDIOMetadata{

  private static String[] RDATA_FILE_INFORMATION_ITEMS= { "" };

    
  /**
   * Constructs a <code>SPSSMetadata</code> object.
   */
  public RDATAMetadata() {
    super();
    _init();
  }
  ...
  private void _init(){
    ...
    for (String it : RDATA_FILE_INFORMATION_ITEMS){
      fileInformation.put(it, "");
    }
  }
