...
INSERT INTO pagedef ( name, path, role_id, networkrole_id ) VALUES ( 'EditNetworkNamePage', '/networkAdmin/EditNetworkNamePage.jsp', null,2 );
...
INSERT INTO vdcnetwork (id, version, name, networkpageheader, networkpagefooter, announcements, displayannouncements, aboutthisdataversenetwork, contactemail, defaultvdcheader, defaultvdcfooter, defaultvdcabouttext, defaultvdcannouncements, displayvdcannouncements, displayvdcrecentstudies, defaulttemplate_id, allowcreaterequest, defaultnetworkadmin_id,protocol,authority,handleregistration) VALUES (1, 1, '[Your]', '<table width="100%" height="85" cellpadding="0" cellspacing="0" title="banner" bgcolor="#FFFFFF" border="0"><tr><td><div style="font-size: 2em; color:#999999; text-align:center;">[Your] Dataverse Network Banner</div> </td></tr></table>', '<table width="100%"><tr><td><div style="font-size: 1em; color:#999999; text-align:center;">Your footer text.</div></td></tr></table>', 'There are no network announcements.', TRUE, 'A description about this Dataverse Network has not been entered yet.', 'dataverse@lists.hmdc.harvard.edu', '<table width="100%"  height="85" cellpadding="0" cellspacing="0" title="banner" bgcolor="#FFFFFF" border="0"><tr><td><div style="font-size: 2em; color:#820024; text-align:center;">[Your] Dataverse Banner</div></td></tr></table>', '<table width="100%"><tr><td><div style="font-size: 1em; color:#999999; text-align:center;">Your footer text.</div></td></tr></table>', 'A description about this dataverse has not been entered yet.', 'There are no local announcements', TRUE, TRUE, 1, FALSE,1,'hdl','TEST',false);
