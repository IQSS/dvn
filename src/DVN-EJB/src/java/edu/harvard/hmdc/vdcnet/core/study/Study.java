...
public class Study implements java.io.Serializable {
    ...
    @OneToMany(mappedBy="study", cascade={CascadeType.REMOVE, CascadeType.MERGE, CascadeType.PERSIST})
    @OrderBy("name ASC")
    private java.util.List<edu.harvard.hmdc.vdcnet.core.study.FileCategory> fileCategories;
    
    /**
     * Getter for property fileCategories.
     * @return Value of property fileCategories.
     */
    public java.util.List<edu.harvard.hmdc.vdcnet.core.study.FileCategory> getFileCategories() {
     ...
     */
    public void setFileCategories(java.util.List<edu.harvard.hmdc.vdcnet.core.study.FileCategory> fileCategories) {
