...
// comment out - not used    public void addStudy(Study study); 
    ...
    edu.harvard.hmdc.vdcnet.core.study.StudyFile getStudyFile(Long fileId);

    edu.harvard.hmdc.vdcnet.core.study.FileCategory getFileCategory(Long fileCategoryId);
    ...
    java.util.List<edu.harvard.hmdc.vdcnet.core.study.Study> getReviewerStudies(Long vdcId);
    java.util.List<edu.harvard.hmdc.vdcnet.core.study.Study> getNewStudies(Long vdcId);
    ...
    edu.harvard.hmdc.vdcnet.core.study.Study saveStudy(Study study, Long userId);

    edu.harvard.hmdc.vdcnet.core.study.Study importHarvestStudy(File xmlFile, Long vdcId, Long userId, String harvestIdentifier);
    edu.harvard.hmdc.vdcnet.core.study.Study importStudy(File xmlFile,  Long harvestFormatTypeId, Long vdcId, Long userId);
    edu.harvard.hmdc.vdcnet.core.study.Study importStudy(File xmlFile,  Long harvestFormatTypeId, Long vdcId, Long userId, List<StudyFileEditBean> filesToUpload);
    edu.harvard.hmdc.vdcnet.core.study.Study importStudy(File xmlFile,  Long harvestFormatTypeId, Long vdcId, Long userId, String harvestIdentifier, List<StudyFileEditBean> filesToUpload);
