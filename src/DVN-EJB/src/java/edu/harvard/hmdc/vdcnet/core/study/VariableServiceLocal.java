...
public interface VariableServiceLocal extends java.io.Serializable {
    edu.harvard.hmdc.vdcnet.core.study.SummaryStatisticType findSummaryStatisticTypeByName(String ssName);

    edu.harvard.hmdc.vdcnet.core.study.VariableFormatType findVariableFormatTypeByName(String name);

    edu.harvard.hmdc.vdcnet.core.study.DataTable getDataTable(Long dtId);

    edu.harvard.hmdc.vdcnet.core.study.VariableIntervalType findVariableIntervalTypeByName(String name);

    edu.harvard.hmdc.vdcnet.core.study.DataVariable getDataVariable(Long dvId);

    void determineStudiesFromVariables(List variables, List studies, Map variableMap);

    edu.harvard.hmdc.vdcnet.core.study.VariableRangeType findVariableRangeTypeByName(String name);
