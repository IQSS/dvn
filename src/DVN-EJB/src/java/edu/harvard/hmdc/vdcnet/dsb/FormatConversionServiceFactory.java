...
public class FormatConversionServiceFactory {
    ...
    public static String FORMAT_CONVERSION_SERVICE_DEFAULT = 
        "edu.harvard.hmdc.vdcnet.dsb.impl.DvnFormatConversionServiceImpl";
        ...
        throws ClassNotFoundException, 
            ...
            if (implClassName == null){
                ...
                return (FormatConversionService)
                    Class.forName("edu.harvard.hmdc.vdcnet.dsb.impl.MockDvnFormatConversionServiceImpl").newInstance();
            } else {
                return (FormatConversionService)
