...
public class AllUsersPage extends VDCBaseBean implements java.io.Serializable  {
     ...
     */
    private List<edu.harvard.hmdc.vdcnet.core.web.networkAdmin.AllUsersDataBean> userData;
    
    /**
     * Getter for property users.
     * @return Value of property users.
     */
    public List<edu.harvard.hmdc.vdcnet.core.web.networkAdmin.AllUsersDataBean> getUserData() {
     ...
     */
    public void setUserData(List<edu.harvard.hmdc.vdcnet.core.web.networkAdmin.AllUsersDataBean> userData) {
