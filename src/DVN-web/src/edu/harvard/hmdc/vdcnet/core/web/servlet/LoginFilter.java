 ...
 */
package edu.harvard.hmdc.vdcnet.core.web.servlet;

import edu.harvard.hmdc.vdcnet.core.admin.GroupServiceLocal;
import edu.harvard.hmdc.vdcnet.core.admin.NetworkRoleServiceLocal;
import edu.harvard.hmdc.vdcnet.core.admin.PageDef;
import edu.harvard.hmdc.vdcnet.core.admin.PageDefServiceLocal;
import edu.harvard.hmdc.vdcnet.core.admin.UserServiceLocal;
import edu.harvard.hmdc.vdcnet.core.admin.RoleServiceLocal;
import edu.harvard.hmdc.vdcnet.core.admin.UserGroup;
import edu.harvard.hmdc.vdcnet.core.admin.VDCRole;
...
import edu.harvard.hmdc.vdcnet.core.study.StudyLock;
...
import edu.harvard.hmdc.vdcnet.core.web.common.LoginBean;
import edu.harvard.hmdc.vdcnet.core.web.common.VDCBaseBean;
import edu.harvard.hmdc.vdcnet.core.web.common.VDCSessionBean;
import java.io.*;
...
@EJBs({
@EJB(name = "collectionService", beanInterface = edu.harvard.hmdc.vdcnet.core.vdc.VDCCollectionServiceLocal.class),
@EJB(name = "studyService", beanInterface = edu.harvard.hmdc.vdcnet.core.study.StudyServiceLocal.class),
@EJB(name = "templateService", beanInterface = edu.harvard.hmdc.vdcnet.core.study.TemplateServiceLocal.class),
@EJB(name = "indexService", beanInterface = edu.harvard.hmdc.vdcnet.core.index.IndexServiceLocal.class),
@EJB(name = "catalogService", beanInterface = edu.harvard.hmdc.vdcnet.core.catalog.CatalogServiceLocal.class),
@EJB(name = "oaiSetService", beanInterface = edu.harvard.hmdc.vdcnet.core.vdc.OAISetServiceLocal.class),
@EJB(name = "harvestStudyService", beanInterface = edu.harvard.hmdc.vdcnet.core.harvest.HarvestStudyServiceLocal.class),
@EJB(name = "vdcGroupService", beanInterface = edu.harvard.hmdc.vdcnet.core.vdc.VDCGroupServiceLocal.class),
@EJB(name = "vdcService", beanInterface = edu.harvard.hmdc.vdcnet.core.vdc.VDCServiceLocal.class),
@EJB(name = "vdcUserService", beanInterface = edu.harvard.hmdc.vdcnet.core.admin.UserServiceLocal.class)
})
