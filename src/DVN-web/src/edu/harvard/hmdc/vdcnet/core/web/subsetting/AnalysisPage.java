...
package edu.harvard.hmdc.vdcnet.core.web.subsetting;
...
import edu.harvard.hmdc.vdcnet.core.admin.DVNVersionServiceLocal;
...
//            });
        ...
        */
         ...
         */
        setStudyUIclassName("edu.harvard.hmdc.vdcnet.core.web.study.StudyUI");
...
//        getVDCRequestBean().setSelectedTab("tabDwnld");
     ...
     */
    private edu.harvard.hmdc.vdcnet.core.study.DataTable dataTable;
...
//                deleteTempFileList.add(vdcstrtFileName);
    ...
    public void init() {
            dbgLog.fine("\n***** init():start "+
                "(edu.harvard.hmdc.vdcnet.core.web.subsetting.AnalysisPage) *****");
        super.init();
        try {
