...
public class AllUsersPage extends VDCBaseBean {
     ...
     */
    private List<edu.harvard.hmdc.vdcnet.web.networkAdmin.AllUsersDataBean> userData;
    
    /**
     * Getter for property users.
     * @return Value of property users.
     */
    public List<edu.harvard.hmdc.vdcnet.web.networkAdmin.AllUsersDataBean> getUserData() {
     ...
     */
    public void setUserData(List<edu.harvard.hmdc.vdcnet.web.networkAdmin.AllUsersDataBean> userData) {
