 ...
 */
public class EditNetworkDepositUseTermsPage extends VDCBaseBean {
    ...
    public String save_action() {
        ...
        try {
            if (validateTerms()) {
                ...
                FacesContext.getCurrentInstance().addMessage("editNetworkDepositUseTermsPage:button1", new FacesMessage(msg));
            } else {
    ...
    public boolean validateTerms() {
        ...
        if ((elementValue == null || elementValue.equals("")) && (termsOfUseEnabled)) {
            ...
            FacesContext.getCurrentInstance().addMessage("content:EditNetworkDepositUseTermsPageView:form1:textArea1", message);
        }
        return isUseTerms;
    }
