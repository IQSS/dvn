       ...
       <h:inputHidden id="vdcId" value="#{VDCRequest.currentVDCId}"/> 
        ...
        <div class="dvn_section">
            <div class="dvn_sectionTitle">
                    ...
                    <h:outputText value="Site Restrictions and User Privileges"/>
                ...
                <div class="dvn_margin12">
                    ...
                    <h:dataTable binding="#{PrivilegedUsersPage.userTable}" cellpadding="0" cellspacing="0"
                        ...
                        <h:column id="column1">
                            ...
                            <h:outputLink id="hyperlink2" value="/dvn/faces/login/AccountPage.jsp?userId=#{currentRow[0].vdcUser.id}">
