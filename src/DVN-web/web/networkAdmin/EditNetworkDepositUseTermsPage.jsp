...
<gui:param name="pageTitle" value="DVN - Edit Data Deposit Use Terms" />
                    ...
                    <div class="dvn_margin12">                    
                       ...
                       <h:messages  layout="list" showDetail="false" showSummary="true" styleClass="successMessage" />                        
                        ...
                        <ui:panelGroup block="true" style="padding-bottom: 15px">
                            ...
                            <h:outputText styleClass="vdcHelpText" value="By enabling these Terms of Use, users will be asked to agree to them when creating a new study or editing an existing study. These terms of use will apply to all the studies in the #{VDCRequest.vdcNetwork.name}  Dataverse Network."/>
                        </ui:panelGroup>
