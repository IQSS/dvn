...
<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core" 
    ...
    <f:subview id="addSitePageView">
                    ...
                    <ui:form binding="#{AddSitePage.form1}" id="form1">
                            <ui:panelLayout binding="#{AddSitePage.layoutPanel1}" id="layoutPanel1" panelLayout="flow" styleClass="vdcSectionMiddleFixed" style="width: 600px">
                                <ui:panelLayout binding="#{AddSitePage.layoutPanel2}" id="layoutPanel2" panelLayout="flow" styleClass="vdcSectionHeader">
                                    <h:outputText binding="#{AddSitePage.outputText1}" value="Add a New Dataverse"/>
                                </ui:panelLayout>
                                <ui:panelLayout binding="#{AddSitePage.layoutPanel3}" id="layoutPanel3" panelLayout="flow" style="padding-left: 20px; padding-top: 30px; padding-bottom: 20px">
