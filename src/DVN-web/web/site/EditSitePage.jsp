    ...
    <f:subview id="editSitePageView">
                    ...
                    <ui:form binding="#{EditSitePage.form1}" id="form1">
                         <h:inputHidden id="vdcId" value="#{VDCRequest.currentVDCId}"/>
                           <ui:panelLayout binding="#{EditSitePage.layoutPanel1}" id="layoutPanel1" panelLayout="flow" styleClass="vdcSectionMiddleFixed" style="width: 600px">
                                <ui:panelLayout binding="#{EditSitePage.layoutPanel2}" id="layoutPanel2" panelLayout="flow" styleClass="vdcSectionHeader">
                                    <h:outputText binding="#{EditSitePage.outputText1}" value="Edit Dataverse Name and Alias"/>
                                </ui:panelLayout>
                                <ui:panelLayout panelLayout="flow" styleClass="vdcSectionMiddleMessage" style="width: 200px; margin-top: 10px; margin-bottom: -10px" rendered="#{!empty EditSitePage.msg.messageText}">
                                 <ui:panelGroup block="true" styleClass="#{EditSitePage.msg.styleClass}" >
                                      <h:outputText id="statusMessage" value="#{EditSitePage.msg.messageText}" /> 
                                 </ui:panelGroup>
                                </ui:panelLayout>
                                <ui:panelLayout binding="#{EditSitePage.layoutPanel3}" id="layoutPanel3" panelLayout="flow" style="padding-left: 20px; padding-top: 30px; padding-bottom: 20px">
