        ...
        <ui:form binding="#{AdvSearchPage.form1}" id="form1">
            <h:inputHidden id="vdcId" value="#{VDCRequest.currentVDCId}"/>
                            <ui:panelLayout  id="layoutPanel1" panelLayout="flow" styleClass="vdcSectionMiddleFixed" style="width: 750px">
                                <ui:panelLayout binding="#{AdvSearchPage.layoutPanel2}" id="layoutPanel2" panelLayout="flow" styleClass="vdcSectionHeader">
                                    <h:outputText binding="#{AdvSearchPage.outputText4}" value="Advanced Search"/>
                                </ui:panelLayout>
                                <ui:panelLayout  panelLayout="flow" style="padding-left: 10px; padding-right: 10px;  padding-top: 30px; padding-bottom: 30px; ">
