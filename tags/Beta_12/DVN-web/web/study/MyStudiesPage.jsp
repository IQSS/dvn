       ...
       <f:subview id="MyStudiesPageView">
                    <ui:form binding="#{MyStudiesPage.form1}" id="form1">
                        <h:inputHidden id="vdcId" value="#{VDCRequest.currentVDCId}"/>
                            <ui:panelLayout binding="#{MyStudiesPage.layoutPanel1}" id="layoutPanel1" panelLayout="flow" styleClass="vdcSectionMiddleNoBorder">
                                <h:panelGrid cellpadding="0" cellspacing="0" columns="1" width="100%">
                                    <ui:panelLayout binding="#{MyStudiesPage.layoutPanel2}" id="layoutPanel2" panelLayout="flow" styleClass="vdcSectionHeader">
                                        <h:outputText binding="#{MyStudiesPage.outputText1}" value="My Studies in #{VDCRequest.currentVDC.name} Dataverse"/>
                                    </ui:panelLayout>
                                    <ui:panelLayout binding="#{MyStudiesPage.layoutPanel3}" id="layoutPanel3" panelLayout="flow" style="padding: 40px 40px 30px 40px; border: 1px solid #cccccc; ">
