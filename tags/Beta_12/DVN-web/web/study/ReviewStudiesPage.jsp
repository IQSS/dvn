       ...
       <f:subview id="ReviewStudiesPageView">
                    <ui:form binding="#{ReviewStudiesPage.form1}" id="form1">
                        <h:inputHidden id="vdcId" value="#{VDCRequest.currentVDCId}"/>
                             <ui:panelLayout binding="#{ReviewStudiesPage.layoutPanel1}" id="layoutPanel1" panelLayout="flow" styleClass="vdcSectionMiddleNoBorder">
                                <h:panelGrid cellpadding="0" cellspacing="0" columns="1" width="100%">
                                <ui:panelLayout binding="#{ReviewStudiesPage.layoutPanel2}" id="layoutPanel2" panelLayout="flow" styleClass="vdcSectionHeader">
                                    <h:outputText binding="#{ReviewStudiesPage.outputText1}"  value="Review Studies in #{VDCRequest.currentVDC.name} Dataverse"/>
                                </ui:panelLayout>
                                <ui:panelLayout binding="#{ReviewStudiesPage.layoutPanel3}" id="layoutPanel3" panelLayout="flow" style="padding: 40px 40px 30px 40px; border: 1px solid #cccccc; ">
                                    ...
                                    <ui:panelGroup block="true" style="padding-top: 10px" visible="#{ReviewStudiesPage.reviewStudies.rowCount == 0 and ReviewStudiesPage.newStudies.rowCount == 0 }">
