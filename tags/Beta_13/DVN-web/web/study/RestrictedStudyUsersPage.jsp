       ...
       <f:subview id="RestrictedStudyUsersPageView">
                    <ui:form binding="#{RestrictedStudyUsersPage.form1}" id="form1">
                        <h:inputHidden id="vdcId" value="#{VDCRequest.currentVDCId}"/>
                            <ui:panelLayout binding="#{RestrictedStudyUsersPage.layoutPanel1}" id="layoutPanel1" panelLayout="flow" styleClass="vdcSectionMiddle">
                                <ui:panelLayout binding="#{RestrictedStudyUsersPage.layoutPanel2}" id="layoutPanel2" panelLayout="flow" styleClass="vdcSectionHeader">
                                    <h:outputText binding="#{RestrictedStudyUsersPage.outputText1}" value="List of Users with Access to Restricted Study/Files"/>
                                </ui:panelLayout>
                                <ui:panelLayout binding="#{RestrictedStudyUsersPage.layoutPanel3}" id="layoutPanel3" panelLayout="flow" style="padding: 40px 40px 30px 40px; ">
